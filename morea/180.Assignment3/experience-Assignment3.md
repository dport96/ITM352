...
*   For this assignment, it would be helpful if you familiarized yourself with _Sessions and Cookies_ from the class lab.
...
*   If you need help, consult the Assignment3 code examples, past labs and WODs before asking for help. When you ask for help the more specific you can be about whatyou need help with the more likely you will get somethign helpful!
...
*   If you have tried the above but still need some assistance, the instructor can help you with _specific_ questions. Email is probably the best way to get help since the instructor isn't always avauilable in person at any given time and class periods are too short to address detailed problems.

**_Remember to start early and finish early!!_**
...
*   Personalize the pages
    ...
    *   After using the application or making a purchase, the last page should say "Thank you, <user's name> for your <using this application>" and other relevant user info (e.g. shipping address for invoice).
...
*   Security
    ...
    *   Use sessions or cookies this time to bar the customer from doing a checkout without being logged in logging in. It should not matter if the customer came from the login or registration page or any other page. The user should be able to login or register at any time before checking out. If they try to checkout without being logged in, redirect them to login.
